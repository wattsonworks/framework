...
deck.html           # 7-page A4 thesis — print to PDF
liquidex-thesis.pdf # the thesis (regenerated from deck.html)
...
- **PDF (the thesis):** edit `deck.html`, then re-export to `liquidex-thesis.pdf` — browser Print → Save as PDF (A4, no margins, background graphics ON), or headless: `msedge --headless=new --no-pdf-header-footer --print-to-pdf="liquidex-thesis.pdf" "http://localhost:PORT/deck.html"`.
